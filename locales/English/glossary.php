...
'Civil Disorder (CD)' => 'Civil Disorder occurs after two <a href="glossary.php?term=No%20Moves%20Received%20(NMR)#No%20Moves%20Received%20(NMR)">NMRs</a>. The player is ejected from the game and the units hold in place. Another player may then take over the position for the current point value based on number of supply centers held.',
